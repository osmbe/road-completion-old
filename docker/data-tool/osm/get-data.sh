...
osmosis --read-pbf ./belgium-latest.osm.pbf --bounding-box left=2.2467041015625 top=51.5429188223739 right=5.899658203125 bottom=50.64249394010323 --write-pbf ./flanders-latest.osm.pbf
# flanders bbox -> brussels bbox
osmosis --read-pbf ./flanders-latest.osm.pbf --bounding-box left=4.23248291015625 top=50.92467892226281 right=4.513320922851562 bottom=50.75904732375726 --write-pbf ./brussels-latest-bbox.osm.pbf
...
# REMARK: removed this, it's just too slow.
