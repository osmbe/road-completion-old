...
ogr2ogr -f GeoJSON -select name,highway -where "highway is not null AND highway NOT IN ( 'pedestrian', 'cycleway', 'path')"  -nln osm_highways -progress  belgium.geojson  belgium-latest.osm.pbf  lines
